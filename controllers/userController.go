...
import (
	...
	helper "github.com/tabrizihamid84/restaurant-management/helpers"
...
func GetUsers() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		projectStage := bson.M{
			"$project": bson.M{"-id": 0, "total_count": 1, "user_items": bson.M{"$slice": []interface{}{"$data", startIndex, recordPerPage}}},
		}
